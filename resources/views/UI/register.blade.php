...
@php
    $title = "Register | Soshine Marketing Company";
    $keywords =  "registration, soshine marketing company, user registration, login, signup";
    $description =  "User Registration Soshine Marketing Company";
@endphp
