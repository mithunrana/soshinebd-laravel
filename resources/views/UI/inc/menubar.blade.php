                            ...
                            <div class="row">
                                <div class="col">
                                    <ul class="mega-item">
                                        ...
                                        <li><a href="{{asset('')}}about-soshine">About Soshine</a></li>
                                        <li><a href="{{asset('')}}contact">Contact Us</a></li>
                                        <li><a href="{{asset('')}}avtech-importer-bangladesh">Avtech Importer</a></li>
                                        <li><a href="{{asset('')}}avtech-distributor-bangladesh">Avtech Distributor In Bangladesh</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
<div style="overflow-y:scroll;" class="mobile-menu">
    ...
    <div class="mm-menu">
        <div class="accordion" id="accordionExample">
            ...
            <div class="menu-box">
                <div class="menu-link" id="headingThree">
                    <a href="{{asset('')}}avtech-support-bangladesh" class="mmenu-btn" >Support</a>
                </div>
            </div>
            <div class="menu-box">
                <div class="menu-link" id="headingThree">
                ...
                <div id="collapseEight" class="collapse menu-body" aria-labelledby="headingEight" data-parent="#accordionExample">
                    <div class="card-body">
                        <ul>
                            ...
                            <li><a href="{{asset('')}}about-soshine">About Soshine</a></li>
                            <li><a href="{{asset('')}}contact">Contact Us</a></li>
                            <li><a href="{{asset('')}}avtech-importer-bangladesh">Avtech Importer BD</a></li>
                            <li><a href="{{asset('')}}avtech-distributor-bangladesh">Avtech Distributor BD</a></li>
                        </ul>
                    </div>
                </div>
            </div>
