...
@php
    $title = "Terms And Condition | Soshine Marketing Company";
    $keywords =  "soshine, marketing, company, terms condition, avtech bangladesh";
    $description =  "soshine marketing company website terms & condition";
@endphp
